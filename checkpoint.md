...
**Last updated:** 2026-06-15 (D5 complete; D6 next) · **Current phase:** Phase 1 (Linux & Systems Foundations) — *common core, discipline-neutral* · **Current week:** Week 1 (Day 1 ✓ Day 2 ✓ Day 3 ✓ Day 4 ✓ Day 5 ✓; Day 6 next) · **Status:** in progress
...
- **Hardening built:** D4 ✓ — bounded PSP retry (backoff + jitter + cap); verified CPU at baseline under 50% error rate. D5 ✓ — correct goroutine/process lifecycle: in-process receipt worker, zero zombies, clean SIGTERM drain. D6 pending.
